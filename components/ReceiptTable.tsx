  ...
  if (receipts.length === 0) {
    return (
      <div className="text-center py-24 bg-brand-surface rounded-3xl border border-dashed border-brand-border">
        ...
        <p className="text-zinc-500 font-bold uppercase tracking-widest text-xs">Pátio Vazio</p>
        <p className="text-zinc-600 text-sm mt-1">Nenhum registro de carga encontrado.</p>
      </div>
    );
  }
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-zinc-900/50 border-b border-brand-border">
              <th className="px-6 py-5 text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">Referência NF</th>
              <th className="px-6 py-5 text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">Recebedor</th>
              <th className="px-6 py-5 text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">Manifesto</th>
              <th className="px-6 py-5 text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">Data / Hora</th>
              <th className="px-6 py-5 text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] text-right">Ações</th>
            </tr>
          </thead>
              ...
              <tr key={r.id} className="hover:bg-zinc-900/30 transition-colors group">
                <td className="px-6 py-5">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-black text-white text-sm tracking-tight">#{r.nf_number}</span>
                  </div>
                </td>
                <td className="px-6 py-5">
                  <div className="flex items-center gap-2">
                    <User className="w-3.5 h-3.5 text-zinc-600" />
                    <span className="text-zinc-300 text-sm font-medium">{r.receiver_name}</span>
                  </div>
                </td>
                <td className="px-6 py-5">
                  <span className="text-zinc-500 text-xs line-clamp-1 max-w-[200px] italic">"{r.product_description}"</span>
                </td>
                <td className="px-6 py-5">
